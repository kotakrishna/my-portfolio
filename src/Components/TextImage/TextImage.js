...
import Text from "../../img/personal/test5.JPG";
export default function TextImage() {
  return (
    <section className={styles.container}>
      <p className={styles.Text} style={{ backgroundImage: `url(${Text})` }}>
        ...
        et lorem. Sed magna purus, fermentum eu, tincidunt eu, varius ut, felis.
        In auctor lobortis lacus. Quisque libero metus, condimentum nec, tempor
        a, commodo mollis, magna. Vestibulum ullamcorper mauris at ligula. Fusce
        ...
        platea dictumst. Fusce a quam. Etiam ut purus mattis mauris.Lorem ipsum
        ...
        feugiat lorem non metus. Vestibulum dapibus nunc ac augue. Curabitur
        vestibulum aliquam leo. Praesent egestas neque eu enim. In hac habitasse
        platea dictumst. Fusce a quam. Etiam ut purus mattis mauris.
      </p>
    </section>
  );
}
